    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center bg-[#f4f6f9] pt-6 sm:pt-0">
        ...
        <div class="w-full sm:max-w-md bg-white shadow-lg sm:rounded-xl overflow-hidden p-8 sm:p-10 border border-gray-100 relative">
            ...
            <div class="flex justify-center mb-6">
                <div class="w-14 h-14 bg-[#1e2333] rounded-lg shadow-sm flex items-center justify-center">
                    <!-- Podemos poner un icono aquí o dejarlo consistente con el login -->
            ...
            <div class="text-center mb-8">
                <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Crear Cuenta</h2>
                <p class="text-[13px] sm:text-sm text-gray-500">Ingresa tus datos para registrarte en el sistema</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <!-- Name -->
                <div>
                    <label for="name" class="block text-[10px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">
                        Nombre Completo
                    </label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        />
                        <button type="button" @click="togglePassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 focus:outline-none">
                ...
                <div>
                    <label for="password_confirmation" class="block text-[10px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            autocomplete="new-password"
                        />
                        <button type="button" @click="togglePasswordConfirmation" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 focus:outline-none">
                            <svg v-if="!showPasswordConfirmation" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
                            <svg v-else class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="mt-8 border-t border-gray-100 pt-6">
                    <p class="text-center text-[13px] sm:text-sm text-gray-500">
                        ...
                        <Link :href="route('login')" class="font-bold text-blue-600 hover:text-blue-500">Inicia Sesión</Link>
                    </p>
                </div>
            </form>
        </div>
